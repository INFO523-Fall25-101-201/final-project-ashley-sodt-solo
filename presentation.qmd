...
## Top Contributors to High-Confidence Anomalies {.smaller}

::: {.content-visible when-format="revealjs"}
```{python}
import pandas as pd

# Load table of top-contributing features
top_contrib_table = pd.read_csv("data/top_feature_contributors.csv")
top_contrib_table
```
