...
- Right hind is remaining on the ground longer than typical → load compensation

- Altered diagonal pairing between limbs → disrupted trot coordination

- Redistribution of load toward the hind limb, potentially preceding visible gait abnormalities

## Limitations 

- Small number of sessions per horse (5-14 sessions)
- External factors (environment, rider, equipment)
- No labeled injury or clinical ground truth
...
**Interpretation:**  
Automated anomaly detection can reveal subtle, horse-specific gait changes that
may indicate early movement irregularities or reinjury risk.
</div>